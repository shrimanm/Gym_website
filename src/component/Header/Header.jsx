...
const Header = () => {
    ...
    return (
        <div className="header">
            ...
            <div style={{backgroundColor:'var(--appColor)',padding:'0.5rem',borderRadius:'5px'}} onClick={() => (setMenuOpened(!menuOpened))} ><img style={{width:'1.5rem', height:"1.5rem"}} src={Bars} alt = "" /></div>) : (<ul className='header-menu'>
                <li ><Link onClick={() => setMenuOpened(false)} to='header' span={true} smooth={true}>Home</Link></li>
