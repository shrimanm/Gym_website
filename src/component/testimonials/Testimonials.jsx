...
const Testimonials = () => {
  ...
  return (
    <div  className='testimonials'>
        <div className="left-t"><span>testimonials</span><span className='stroke-text'>what they</span><span>say about us</span>
        ...
        <div className="right-t">
            ...
            <div className="arrows">
                ...
                <img src={rightArrow} alt="" onClick={handleRightArrow}/>
            </div>
        </div>
